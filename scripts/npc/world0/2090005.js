    ...
    if(mode == -1) {
        ...
        if (status == 0) {
            ...
            if(cm.getPlayer().getMapId() == 251000000) {
                cm.sendYesNo("Hello there. How's the traveling so far? I've been transporting other travelers like you to #b"+menu[3]+"#k in no time, and... are you iterested? It's not as stable as the ship, so you'll have to hold on tight, but i can get there much faster than the ship. I'll take you there as long as you pay #b"+cost[2]+" mesos#k.");
            } else if(cm.getPlayer().getMapId() == 250000100) {
